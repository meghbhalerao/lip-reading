...
ap.add_argument("-i", "--input", required=True,
                help=r"H:\MEGH\NITK\Third Year - B.Tech NITK\Fifth Semester\CMCK Mini Project\Olivia Munn Talks 'The Predator' Controversy- 'I Don't Know How to Lie About It' - TIFF 2018.mp4")
ap.add_argument("-o", "--output", required=True,
                help=r"H:\MEGH\NITK\Third Year - B.Tech NITK\Fifth Semester\CMCK Mini Project")
